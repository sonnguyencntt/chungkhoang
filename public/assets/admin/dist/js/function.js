...
$('.sidebar-toggle').click(function() {
    if($('.main-header>.logo>.logo-mini').css('display') == 'none')
    {
        $('.user-panel>.image>img').css({'width' : '33px' , 'height' : '33px'});
    }
    else
    {
        $('.user-panel>.image>img').css({'width' : '50px' , 'height' : '50px'});

    }
})
$(".slimScrollDiv>section").hover(function(){
    $('.user-panel>.image>img').css({'width' : '50px' , 'height' : '50px'});
    }, function(){
        $('.user-panel>.image>img').css({'width' : '33px' , 'height' : '33px'});
  });
